...
export function getPagesProjects(args: GetPagesProjectsArgs, opts?: pulumi.InvokeOptions): Promise<GetPagesProjectsResult> {
    pulumi.log.warn("getPagesProjects is deprecated: cloudflare.index/getpagesprojects.getPagesProjects has been deprecated in favor of cloudflare.pages/getprojects.getProjects")
