...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 validation_data: Optional[pulumi.Input['DomainValidationDataArgs']] = None,
                 verification_data: Optional[pulumi.Input['DomainVerificationDataArgs']] = None,
    ...
    def validation_data(self) -> Optional[pulumi.Input['DomainValidationDataArgs']]:
        return pulumi.get(self, "validation_data")

    @validation_data.setter
    def validation_data(self, value: Optional[pulumi.Input['DomainValidationDataArgs']]):
        pulumi.set(self, "validation_data", value)

    @_builtins.property
    @pulumi.getter(name="verificationData")
    def verification_data(self) -> Optional[pulumi.Input['DomainVerificationDataArgs']]:
        return pulumi.get(self, "verification_data")

    @verification_data.setter
    def verification_data(self, value: Optional[pulumi.Input['DomainVerificationDataArgs']]):
...
@pulumi.type_token("cloudflare:pages/domain:Domain")
class Domain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="cloudflare:index/pagesDomain:PagesDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Domain, __self__).__init__(
            'cloudflare:pages/domain:Domain',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            project_name: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            validation_data: Optional[pulumi.Input[Union['DomainValidationDataArgs', 'DomainValidationDataArgsDict']]] = None,
            verification_data: Optional[pulumi.Input[Union['DomainVerificationDataArgs', 'DomainVerificationDataArgsDict']]] = None,
            zone_tag: Optional[pulumi.Input[_builtins.str]] = None) -> 'Domain':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="validationData")
    def validation_data(self) -> pulumi.Output['outputs.DomainValidationData']:
        return pulumi.get(self, "validation_data")

    @_builtins.property
    @pulumi.getter(name="verificationData")
    def verification_data(self) -> pulumi.Output['outputs.DomainVerificationData']:
        return pulumi.get(self, "verification_data")
