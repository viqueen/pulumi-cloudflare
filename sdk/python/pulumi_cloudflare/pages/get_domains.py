...
class GetDomainsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetDomainsResultResult']:
        """
...
def get_domains(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pages/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult).value
...
def get_domains_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pages/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult)
