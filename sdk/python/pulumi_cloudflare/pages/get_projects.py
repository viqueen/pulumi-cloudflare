...
def get_projects(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pages/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult).value
...
def get_projects_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pages/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult)
