...
class GetDomainResult:
    ...
    def validation_data(self) -> 'outputs.GetDomainValidationDataResult':
        return pulumi.get(self, "validation_data")

    @_builtins.property
    @pulumi.getter(name="verificationData")
    def verification_data(self) -> 'outputs.GetDomainVerificationDataResult':
...
def get_domain(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pages/getDomain:getDomain', __args__, opts=opts, typ=GetDomainResult).value
...
def get_domain_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pages/getDomain:getDomain', __args__, opts=opts, typ=GetDomainResult)
