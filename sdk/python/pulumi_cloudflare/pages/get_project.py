...
class GetProjectResult:
    ...
    def build_config(self) -> 'outputs.GetProjectBuildConfigResult':
        """
    ...
    def canonical_deployment(self) -> 'outputs.GetProjectCanonicalDeploymentResult':
        """
    ...
    def deployment_configs(self) -> 'outputs.GetProjectDeploymentConfigsResult':
        """
    ...
    def latest_deployment(self) -> 'outputs.GetProjectLatestDeploymentResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def source(self) -> 'outputs.GetProjectSourceResult':
        """
...
def get_project(account_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:pages/getProject:getProject', __args__, opts=opts, typ=GetProjectResult).value
...
def get_project_output(account_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:pages/getProject:getProject', __args__, opts=opts, typ=GetProjectResult)
